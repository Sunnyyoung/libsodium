...
export MACOS_VERSION_MIN=${MACOS_VERSION_MIN-"10.11"}
export IOS_SIMULATOR_VERSION_MIN=${IOS_SIMULATOR_VERSION_MIN-"9.0"}
export IOS_VERSION_MIN=${IOS_VERSION_MIN-"9.0"}
export WATCHOS_SIMULATOR_VERSION_MIN=${WATCHOS_SIMULATOR_VERSION_MIN-"3.0"}
export WATCHOS_VERSION_MIN=${WATCHOS_VERSION_MIN-"3.0"}
export TVOS_SIMULATOR_VERSION_MIN=${TVOS_SIMULATOR_VERSION_MIN-"9.0"}
export TVOS_VERSION_MIN=${TVOS_VERSION_MIN-"9.0"}
...
echo "Creating libsodium.xcframework..."

rm -rf "${PREFIX}/libsodium.xcframework"
...
xcodebuild -create-xcframework ${XCFRAMEWORK_ARGS} -output "${PREFIX}/libsodium.xcframework" >/dev/null

ls -l -- "$PREFIX/libsodium.xcframework"

rm -rf "${ROOT}/libsodium.xcframework"
cp -a "${PREFIX}/libsodium.xcframework" ${ROOT}
